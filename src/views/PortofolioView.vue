<template>
  <StandardLayout 
    title="Portofolio" 
    subtitle="Kelola dan tampilkan portofolio akademik Anda"
  >
    <!-- Header Actions -->
    <template #headerActions>
      <div class="header-stats">
        <div class="stat-item">
          <span class="stat-number">{{ publikasiList.length }}</span>
          <span class="stat-label">Publikasi</span>
        </div>
        <div class="stat-item">
          <span class="stat-number">{{ penelitianList.length }}</span>
          <span class="stat-label">Penelitian</span>
        </div>
        <div class="stat-item">
          <span class="stat-number">{{ pengabdianList.length }}</span>
      ...
      <div class="filter-group">
        <div class="search-box">
          ...
          <input 
            v-model="searchQuery" 
            type="text" 
            placeholder="Cari dalam portofolio..."
            class="search-input"
          />
        </div>
      ...
      <div class="portofolio-sections">
        ...
        <div class="section">
          <div class="section-header">
            <h2>Publikasi</h2>
            <button class="btn-add" @click="showPublikasiModal = true">
              <Plus :size="16" />
              Tambah
            </button>
          </div>
        ...
        <div class="section">
          <div class="section-header">
            <h2>Penelitian</h2>
            <button class="btn-add" @click="showPenelitianModal = true">
              <Plus :size="16" />
              Tambah
            </button>
          </div>
        ...
        <div class="section">
          <div class="section-header">
            ...
            <button class="btn-add" @click="showPengabdianModal = true">
              <Plus :size="16" />
              Tambah
            </button>
          </div>
...
.item-card:hover {
  ...
  border-color: var(--oba-primary-light);
}
